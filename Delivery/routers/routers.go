...
import (
	custommongo "Back/CustomMongo"
	"Back/Domain"
	email_service "Back/Infrastructure/email_service"
	"context"
...
func sendemail(c *gin.Context) {
	...
	err := em.SendEmail("eyob.mamo@a2sv.org", "Test", "This is a test email", "catagory1")
	if err != nil {
		c.JSON(400, gin.H{
			"error": err.Error(),
		})
